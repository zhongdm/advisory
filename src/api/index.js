...
import { LOGIN, LOGOUT, USER_LIST, ADD_USER, EDIT_USER, DELETE_USER,
          ...
          ROLE_BY_USER_ID, UPDATE_ROLE_BY_USER_ID, AUTH_MENU_BY_ROLE_ID, UPDATE_AUTH_MENU_BY_ROLE_ID,
          LOG_LIST } from './const'
...
export const resetPwd = params => {
  return new Promise((resolve, reject) => {
    axios.post(`${RESET_PASSWORD}/${params.id}`, params)
      .then(response => {
      resolve(response.data);
    }, err => {
      // resolve(defaultValue.login);
...
export const getLogList = params => {
  return new Promise((resolve, reject) => {
    axios.post(`${LOG_LIST}`, params).then(response => {
      resolve(response.data);
    }, err => {
      // resolve(defaultValue.login);
    })
